                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Sign in to continue to RQA SYSTEM.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0"> 
                                    ...
                                    <a href="index.html" class="auth-logo-light">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="assets/images/sdo.png" alt="" class="rounded-circle" height="34">
                                            </span>
                                        </div>
                                    </a>
                                ...
                                <div class="p-2">
                                    ...
                                    <div class="mt-5 text-center">
                                        <div>
                                            <p>Don't have an account ? <a href="{{route('appregister')}}" class="fw-medium text-primary"> Signup now </a> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
